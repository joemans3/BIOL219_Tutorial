...
def ramachandran(file_name_list):
                    ...
                    for res_index, residue in enumerate(poly):
                        ...
                        if phi and psi:
                            if str(poly[res_index + 1].resname) == "PRO":
                                ...
                                aa_type = "General"
                            if rama_pref_values[aa_type][int(math.degrees(psi)) + 180][int(math.degrees(phi)) + 180] <                                     rama_preferences[aa_type]["bounds"][1]:
    ...
    plt.tight_layout()
    plt.savefig("{0}.png".format(file_name_list[0][:int(len(file_name_list)-4)]), dpi=300)
    plt.show()
...
ramachandran(["1hho.pdb"])


# In[4]:

ramachandran(["1igt.pdb"])


# In[5]:

ramachandran(["2ypi.pdb"])
